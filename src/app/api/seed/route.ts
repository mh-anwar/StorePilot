...
export async function POST(req: Request) {
  ...
  // Push schema first via drizzle-kit equivalent — create tables if they don't exist
  ...
  await sql`
    DO $$ BEGIN
      CREATE TYPE analytics_event_type AS ENUM ('page_view','product_view','add_to_cart','remove_from_cart','begin_checkout','purchase','search','refund');
    EXCEPTION WHEN duplicate_object THEN NULL; END $$
  `;
  await sql`
    DO $$ BEGIN
